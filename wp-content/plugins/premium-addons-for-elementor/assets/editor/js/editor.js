(function () {
    ...
    window.paGetTranslate = function (e, t) {
        return elementorCommon.translate(e, null, t, PremiumPanelSettings.i18n)
    };
    ...
    elementor.hooks.addFilter("panel/elements/regionViews", function (panel) {
        ...
        _.each(PremiumPanelSettings.papro_widgets, function (widget, index) {
            widgets.add({
                name: widget.key,
                title: PremiumPanelSettings.i18n.pa_dialog_prefix + widget.title,
                icon: widget.icon,
        ...
        paWidgetsPromoHandler = {
            ...
            onMouseDown: function () {
                ...
                elementor.promotion.dialog.buttons[0].addClass("premium-promotion-btn");

                elementor.promotion.showDialog({
                    headerMessage: paGetTranslate("pa_dialog_header", [this.model.get("title")]),
                    message: paGetTranslate("pa_dialog_message", [this.model.get("title")]),
                    top: "-7",
                    element: this.el,
