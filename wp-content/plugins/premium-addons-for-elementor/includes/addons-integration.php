	...
	public function after_enqueue_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'            => array(
					'pa_dialog_prefix'  => esc_html__( 'Premium ', 'premium-addons-for-elementor' ),
					'pa_dialog_header'  => esc_html__( '%s Widget', 'premium-addons-for-elementor' ),
					'pa_dialog_message' => esc_html__( 'Use %s widget with other exclusive pro widgets and 100% unique features to extend your toolbox and build sites faster and better.', 'premium-addons-for-elementor' ),
				),
			)
		);
